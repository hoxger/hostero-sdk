...
from .resources import GameServer, GameServerPage
...
class ServersService:
    ...
    def list(
        ...
        *,
        ...
        return GameServerPage(
            data=PaginatedResponseGameServerListItemResource._from_dict(
                response.json()
            ),
            _service=self,
        )
    ...
    def get(self, server_id: str) -> GameServer:
        ...
        return GameServer(
            data=GameServerDetailResource._from_dict(response.json()), _service=self
        )
